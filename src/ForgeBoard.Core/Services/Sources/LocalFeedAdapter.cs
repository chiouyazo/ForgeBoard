...
public sealed class LocalFeedAdapter : IFeedAdapter
{
    ...
    private readonly ILogger<LocalFeedAdapter> _logger;

    public FeedType SourceType => FeedType.LocalPath;

    public LocalFeedAdapter(ILogger<LocalFeedAdapter> logger)
    {
    ...
    )
    {
        ...
        bool exists = Directory.Exists(feed.ConnectionString) || File.Exists(feed.ConnectionString);
    ...
    )
    {
        ...
        _logger.LogInformation(
            "Pulling file {FileName} from local path {Path}",
            fileName,
    ...
    )
    {
        ...
        _logger.LogInformation(
            "Pushed file {FileName} to local path {Path}",
            fileName,
            feed.ConnectionString
        );
    }
